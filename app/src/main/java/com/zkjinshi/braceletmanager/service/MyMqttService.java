package com.zkjinshi.braceletmanager.service;
...
public class MyMqttService extends Service implements MqttCallback {
    ...
    public static final String DEBUG_TAG = "MyMqttService"; // Debug TAG
        ...
        mConnHandler.post(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    mClient.subscribe(SUBSCRIBE_TOPIC, 0);
    ...
    private void startKeepAlives() {
        Intent i = new Intent();
        i.setClass(this, MyMqttService.class);
        i.setAction(ACTION_KEEPALIVE);
    ...
    public void messageArrived(String s, MqttMessage message) throws Exception {
        Log.i(DEBUG_TAG,"mqtt received from topic:\t" + s +
                "  Message:\t" + new String(message.getPayload()) +
                "  QoS:\t" + message.getQos());

        // {"apid": "ap110", "payload": "126683000000", "rssi": -32, "alert": "y", "bracelet": "82", "message":"msg!", "address":"address"}
        ...
        if(null != sosMessage) {
            //if (new Date().getTime() - CacheUtil.getInstance().getBraceletTime(sosMessage.getBracelet()) > 5000) {
                NotificationHelper.getInstance().showNotification(getApplicationContext(), sosMessage);
